...
export class CommitBlockResponse extends jspb.Message {
  getStatus(): CommitBlockStatusMap[keyof CommitBlockStatusMap];
  setStatus(value: CommitBlockStatusMap[keyof CommitBlockStatusMap]): void;
...
export namespace CommitBlockResponse {
  export type AsObject = {
    status: CommitBlockStatusMap[keyof CommitBlockStatusMap],
  }
}
...
export interface CommitBlockStatusMap {
  SUCCEEDED: 0;
  FAILED: 1;
}

export const CommitBlockStatus: CommitBlockStatusMap;
